...
module.exports = (function() {
  ...
  function parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$c126 = "\\begin{matrix}",
        peg$c127 = { type: "literal", value: "\\begin{matrix}", description: "\"\\\\begin{matrix}\"" },
        peg$c128 = "\\end{matrix}",
        peg$c129 = { type: "literal", value: "\\end{matrix}", description: "\"\\\\end{matrix}\"" },
        peg$c130 = "\\begin{pmatrix}",
        peg$c131 = { type: "literal", value: "\\begin{pmatrix}", description: "\"\\\\begin{pmatrix}\"" },
        peg$c132 = "\\end{pmatrix}",
        peg$c133 = { type: "literal", value: "\\end{pmatrix}", description: "\"\\\\end{pmatrix}\"" },
        peg$c134 = "\\begin{bmatrix}",
        peg$c135 = { type: "literal", value: "\\begin{bmatrix}", description: "\"\\\\begin{bmatrix}\"" },
        peg$c136 = "\\end{bmatrix}",
        peg$c137 = { type: "literal", value: "\\end{bmatrix}", description: "\"\\\\end{bmatrix}\"" },
        peg$c138 = "\\begin{Bmatrix}",
        peg$c139 = { type: "literal", value: "\\begin{Bmatrix}", description: "\"\\\\begin{Bmatrix}\"" },
        peg$c140 = "\\end{Bmatrix}",
        peg$c141 = { type: "literal", value: "\\end{Bmatrix}", description: "\"\\\\end{Bmatrix}\"" },
        peg$c142 = "\\begin{vmatrix}",
        peg$c143 = { type: "literal", value: "\\begin{vmatrix}", description: "\"\\\\begin{vmatrix}\"" },
        peg$c144 = "\\end{vmatrix}",
        peg$c145 = { type: "literal", value: "\\end{vmatrix}", description: "\"\\\\end{vmatrix}\"" },
        peg$c146 = "\\begin{Vmatrix}",
        peg$c147 = { type: "literal", value: "\\begin{Vmatrix}", description: "\"\\\\begin{Vmatrix}\"" },
        peg$c148 = "\\end{Vmatrix}",
        peg$c149 = { type: "literal", value: "\\end{Vmatrix}", description: "\"\\\\end{Vmatrix}\"" },
        peg$c150 = "\\begin{array}",
        peg$c151 = { type: "literal", value: "\\begin{array}", description: "\"\\\\begin{array}\"" },
        peg$c152 = "\\end{array}",
        peg$c153 = { type: "literal", value: "\\end{array}", description: "\"\\\\end{array}\"" },
        peg$c154 = "\\begin{align}",
        peg$c155 = { type: "literal", value: "\\begin{align}", description: "\"\\\\begin{align}\"" },
        peg$c156 = "\\end{align}",
        peg$c157 = { type: "literal", value: "\\end{align}", description: "\"\\\\end{align}\"" },
        peg$c158 = "\\begin{aligned}",
        peg$c159 = { type: "literal", value: "\\begin{aligned}", description: "\"\\\\begin{aligned}\"" },
        peg$c160 = "\\end{aligned}",
        peg$c161 = { type: "literal", value: "\\end{aligned}", description: "\"\\\\end{aligned}\"" },
        peg$c162 = "\\begin{alignat}",
        peg$c163 = { type: "literal", value: "\\begin{alignat}", description: "\"\\\\begin{alignat}\"" },
        peg$c164 = "\\end{alignat}",
        peg$c165 = { type: "literal", value: "\\end{alignat}", description: "\"\\\\end{alignat}\"" },
        peg$c166 = "\\begin{alignedat}",
        peg$c167 = { type: "literal", value: "\\begin{alignedat}", description: "\"\\\\begin{alignedat}\"" },
        peg$c168 = "\\end{alignedat}",
        peg$c169 = { type: "literal", value: "\\end{alignedat}", description: "\"\\\\end{alignedat}\"" },
        peg$c170 = "\\begin{smallmatrix}",
        peg$c171 = { type: "literal", value: "\\begin{smallmatrix}", description: "\"\\\\begin{smallmatrix}\"" },
        peg$c172 = "\\end{smallmatrix}",
        peg$c173 = { type: "literal", value: "\\end{smallmatrix}", description: "\"\\\\end{smallmatrix}\"" },
        peg$c174 = "\\begin{cases}",
        peg$c175 = { type: "literal", value: "\\begin{cases}", description: "\"\\\\begin{cases}\"" },
        peg$c176 = "\\end{cases}",
        peg$c177 = { type: "literal", value: "\\end{cases}", description: "\"\\\\end{cases}\"" },
        peg$c178 = "]",
        ...
        peg$c201 = function(cs) { return "{named}" + cs; },
        peg$c202 = "gray",
        peg$c203 = { type: "literal", value: "gray", description: "\"gray\"" },
        peg$c204 = function(cs) { return "{gray}" + cs; },
        peg$c205 = "rgb",
        peg$c206 = { type: "literal", value: "rgb", description: "\"rgb\"" },
        peg$c207 = function(cs) { return "{rgb}" + cs; },
        peg$c208 = "cmyk",
        peg$c209 = { type: "literal", value: "cmyk", description: "\"cmyk\"" },
        peg$c210 = function(cs) { return "{cmyk}" + cs; },
        ...
        peg$c226 = function() { return text().replace(/\s+$/g, ''); },
        peg$c227 = function() { return false; },
        peg$c228 = function() { return peg$currPos === input.length; },
    ...
    function peg$parseBEGIN_BBMATRIX() {
      ...
      s0 = peg$currPos;
      if (input.substr(peg$currPos, 15) === peg$c138) {
        s1 = peg$c138;
        peg$currPos += 15;
      } else {
        s1 = peg$FAILED;
