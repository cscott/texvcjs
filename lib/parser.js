...
module.exports = (function() {
  ...
  function parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$c124 = function(f) { return options.usemathrm && tu.other_literals2[f]; },
        peg$c125 = function(f) { return ast.RenderT.TEX_ONLY("\\mathrm {" + f + "} "); },
        peg$c126 = function(mathrm) { return options.usemathrm && mathrm === "\\mathrm"; },
        peg$c127 = function(mathrm, f) { return options.usemathrm && tu.other_literals2[f]; },
        peg$c128 = function(mathrm, f) { return options.usemathrm && ast.RenderT.TEX_ONLY("\\mathrm {" + f + "} "); },
