...
module.exports = (function() {
  ...
  function parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$c156 = "\\begin{aligned}",
        peg$c157 = { type: "literal", value: "\\begin{aligned}", description: "\"\\\\begin{aligned}\"" },
        peg$c158 = "\\end{aligned}",
        peg$c159 = { type: "literal", value: "\\end{aligned}", description: "\"\\\\end{aligned}\"" },
        ...
        peg$c164 = "\\begin{alignedat}",
        peg$c165 = { type: "literal", value: "\\begin{alignedat}", description: "\"\\\\begin{alignedat}\"" },
        peg$c166 = "\\end{alignedat}",
        peg$c167 = { type: "literal", value: "\\end{alignedat}", description: "\"\\\\end{alignedat}\"" },
        peg$c168 = "\\begin{smallmatrix}",
        peg$c169 = { type: "literal", value: "\\begin{smallmatrix}", description: "\"\\\\begin{smallmatrix}\"" },
        peg$c170 = "\\end{smallmatrix}",
        peg$c171 = { type: "literal", value: "\\end{smallmatrix}", description: "\"\\\\end{smallmatrix}\"" },
        peg$c172 = "\\begin{cases}",
        peg$c173 = { type: "literal", value: "\\begin{cases}", description: "\"\\\\begin{cases}\"" },
        peg$c174 = "\\end{cases}",
        peg$c175 = { type: "literal", value: "\\end{cases}", description: "\"\\\\end{cases}\"" },
        peg$c176 = "]",
        peg$c177 = { type: "literal", value: "]", description: "\"]\"" },
        peg$c178 = "^",
        peg$c179 = { type: "literal", value: "^", description: "\"^\"" },
        peg$c180 = "_",
        peg$c181 = { type: "literal", value: "_", description: "\"_\"" },
        peg$c182 = function() { return text(); },
        peg$c183 = function(f) { return big_literals[f]; },
        peg$c184 = function(f) { return fun_ar1[f]; },
        peg$c185 = function(f) { return other_fun_ar1[f]; },
        peg$c186 = function(f) { return fun_ar2[f]; },
        peg$c187 = function(f) { return fun_infix[f]; },
        peg$c188 = function(f) { return declh_function[f]; },
        peg$c189 = function(f) { return ast.Tex.DECLh(f, ast.FontForce.RM(), []); /*see bug 54818*/ },
        peg$c190 = function(f) { return fun_ar2nb[f]; },
        peg$c191 = function(f) { return left_function[f]; },
        peg$c192 = function(f) { return right_function[f]; },
        peg$c193 = function() { return false; },
        peg$c194 = function() { return peg$currPos === input.length; },
    ...
    function peg$parseBEGIN_SMALLMATRIX() {
      ...
      s0 = peg$currPos;
      if (input.substr(peg$currPos, 19) === peg$c168) {
        s1 = peg$c168;
        peg$currPos += 19;
      } else {
        s1 = peg$FAILED;
