...
module.exports = (function() {
  ...
  function parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$c97 = function(f) { return other_literals3[f]; },
        peg$c98 = function(f) { return ast.RenderT.TEX_ONLY(other_literals3[f] + " "); },
        peg$c99 = "\\",
        peg$c100 = { type: "literal", value: "\\", description: "\"\\\\\"" },
        peg$c101 = /^[, ;!_#%$&]/,
        peg$c102 = { type: "class", value: "[, ;!_#%$&]", description: "[, ;!_#%$&]" },
        peg$c103 = function(c) { return ast.RenderT.TEX_ONLY("\\" + c); },
        peg$c104 = /^[><~]/,
        peg$c105 = { type: "class", value: "[><~]", description: "[><~]" },
        peg$c106 = /^[%$]/,
        peg$c107 = { type: "class", value: "[%$]", description: "[%$]" },
        peg$c108 = function(c) { return ast.RenderT.TEX_ONLY("\\" + c); /* escape dangerous chars */},
        peg$c109 = /^[{}|]/,
        peg$c110 = { type: "class", value: "[{}|]", description: "[{}|]" },
        peg$c111 = function(f) { return other_delimiters1[f]; },
        peg$c112 = function(f) { return other_delimiters2[f]; },
        peg$c113 = function(f) { return ast.RenderT.TEX_ONLY(other_delimiters2[f] + " "); },
        peg$c114 = function(f) { return fun_ar1nb[f]; },
        peg$c115 = function(f) { return f; },
        peg$c116 = function(f) { return fun_ar1opt[f]; },
        peg$c117 = "&",
        peg$c118 = { type: "literal", value: "&", description: "\"&\"" },
        peg$c119 = "\\\\",
        peg$c120 = { type: "literal", value: "\\\\", description: "\"\\\\\\\\\"" },
        peg$c121 = "\\begin{matrix}",
        peg$c122 = { type: "literal", value: "\\begin{matrix}", description: "\"\\\\begin{matrix}\"" },
        peg$c123 = "\\end{matrix}",
        peg$c124 = { type: "literal", value: "\\end{matrix}", description: "\"\\\\end{matrix}\"" },
        peg$c125 = "\\begin{pmatrix}",
        peg$c126 = { type: "literal", value: "\\begin{pmatrix}", description: "\"\\\\begin{pmatrix}\"" },
        peg$c127 = "\\end{pmatrix}",
        peg$c128 = { type: "literal", value: "\\end{pmatrix}", description: "\"\\\\end{pmatrix}\"" },
        peg$c129 = "\\begin{bmatrix}",
        peg$c130 = { type: "literal", value: "\\begin{bmatrix}", description: "\"\\\\begin{bmatrix}\"" },
        peg$c131 = "\\end{bmatrix}",
        peg$c132 = { type: "literal", value: "\\end{bmatrix}", description: "\"\\\\end{bmatrix}\"" },
        ...
        peg$c137 = "\\begin{vmatrix}",
        peg$c138 = { type: "literal", value: "\\begin{vmatrix}", description: "\"\\\\begin{vmatrix}\"" },
        peg$c139 = "\\end{vmatrix}",
        peg$c140 = { type: "literal", value: "\\end{vmatrix}", description: "\"\\\\end{vmatrix}\"" },
        ...
        peg$c145 = "\\begin{array}",
        peg$c146 = { type: "literal", value: "\\begin{array}", description: "\"\\\\begin{array}\"" },
        peg$c147 = "\\end{array}",
        peg$c148 = { type: "literal", value: "\\end{array}", description: "\"\\\\end{array}\"" },
        peg$c149 = "\\begin{align}",
        peg$c150 = { type: "literal", value: "\\begin{align}", description: "\"\\\\begin{align}\"" },
        peg$c151 = "\\end{align}",
        peg$c152 = { type: "literal", value: "\\end{align}", description: "\"\\\\end{align}\"" },
        peg$c153 = "\\begin{alignat}",
        peg$c154 = { type: "literal", value: "\\begin{alignat}", description: "\"\\\\begin{alignat}\"" },
        peg$c155 = "\\end{alignat}",
        peg$c156 = { type: "literal", value: "\\end{alignat}", description: "\"\\\\end{alignat}\"" },
        peg$c157 = "\\begin{smallmatrix}",
        peg$c158 = { type: "literal", value: "\\begin{smallmatrix}", description: "\"\\\\begin{smallmatrix}\"" },
        peg$c159 = "\\end{smallmatrix}",
        peg$c160 = { type: "literal", value: "\\end{smallmatrix}", description: "\"\\\\end{smallmatrix}\"" },
        peg$c161 = "\\begin{cases}",
        peg$c162 = { type: "literal", value: "\\begin{cases}", description: "\"\\\\begin{cases}\"" },
        peg$c163 = "\\end{cases}",
        peg$c164 = { type: "literal", value: "\\end{cases}", description: "\"\\\\end{cases}\"" },
        peg$c165 = "]",
        ...
        peg$c172 = function(f) { return big_literals[f]; },
        peg$c173 = function(f) { return f + " "; },
        peg$c174 = function(f) { return fun_ar1[f]; },
        peg$c175 = function(f) { return other_fun_ar1[f]; },
        peg$c176 = function(f) { return other_fun_ar1[f] + " "; },
        peg$c177 = function(f) { return fun_ar2[f]; },
        peg$c178 = function(f) { return fun_infix[f]; },
        peg$c179 = function(f) { return declh_function[f]; },
        peg$c180 = function(f) { return ast.Tex.DECLh(f + " ", ast.FontForce.RM(), []); /*see bug 54818*/ },
        peg$c181 = function(f) { return fun_ar2nb[f]; },
        peg$c182 = function(f) { return left_function[f]; },
        peg$c183 = function(f) { return right_function[f]; },
        peg$c184 = function() { return false; },
        peg$c185 = function() { return peg$currPos === input.length; },
