...
const getSub = function (x) {
    if (x instanceof Array) {
        return applyOnArray(x, 'extractSubscripts');
    }
    return x.extractSubscripts();
};
...
ast.Tex.defineVisitor('extractSubscripts', {
    ARRAY: function (...args) {
        return applyOnArray(args, 'extractSubscripts');
    },
    ...
    DQ: function (base, down) {
        const d = [].concat(down.extractSubscripts()),
            b = base.extractSubscripts();
