  ...
  = f:HLINE l:line_start
    {
        ...
        l[0].unshift(ast.Tex.LITERAL(ast.RenderT.TEX_ONLY(f + " "))); return l;}
  / line
line
...
column_spec
  = CURLY_OPEN cs:(one_col+ { return text(); }) CURLY_CLOSE
    { return ast.Tex.CURLY(ast.Tex.ARRAY(ast.Tex.LITERAL(ast.RenderT.TEX_ONLY(cs)))); }
...
alignat_spec
  = CURLY_OPEN num:([0-9]+ { return text(); }) _ CURLY_CLOSE
    { return ast.Tex.CURLY(ast.Tex.ARRAY(ast.Tex.LITERAL(ast.RenderT.TEX_ONLY(num)))); }
...
chem_sentence =
    _ p:chem_phrase " " s:chem_sentence                  { return ast.Tex.ARRAY(p,ast.Tex.ARRAY(ast.Tex.LITERAL(ast.RenderT.TEX_ONLY(" ")),s)); } /
...
chem_bond
 = CURLY_OPEN e:CHEM_BOND_TYPE CURLY_CLOSE               { return ast.Tex.CURLY(ast.Tex.ARRAY(ast.Tex.LITERAL(ast.RenderT.TEX_ONLY(e)))); }
...
chem_script =
    ...
    a:CHEM_SUPERSUB BEGIN_MATH b:expr END_MATH           { return ast.Tex.CHEM_WORD(ast.Tex.LITERAL(ast.RenderT.TEX_ONLY(a)), ast.Tex.DOLLAR(lst2arr(b))); }
