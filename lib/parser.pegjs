...
BOX
 = ("\\text"/"\\mbox"/"\\hbox"/"\\vbox") _ "{" boxchars+ "}" _

LITERAL
 = ( literal_id / literal_mn / literal_uf_lt / "-" / literal_uf_op ) _
 / "\\" latex_function_names _ ( "(" / "[" / "\\{" / { return " ";}) _
 / "\\" mediawiki_function_names ( "(" / "[" / "\\{" / { return " ";}) _
 / other_literals1 _ // Texutil.find(...)
 / other_literals2 _ // Texutil.find(...)
 / other_literals3 _ // Texutil.find(...)
 / "\\" [, ;!_#%$&] _
 / [><~] _
 / [%$] _

DELIMITER
 = ( delimiter_uf_lt / delimiter_uf_op ) _
 / [{}|] _
 / "[" _
 / other_delimiters1 _ // Texutil.find(...)
 / other_delimiters2 _ // Texutil.find(...)

FUN_AR1nb
 = "\\operatorname" _

FUN_AR1opt
 = ("\\sqrt" / "\\xleftarrow" / "\\xrightarrow" ) _ "[" _
