...
lit
  ...
  / f:generic_func
    &{ return f!=='\\right'; } // XXX master list of right contexts
...
other_literals1
 = f:generic_func &{ return other_literals1[f]; }
   { return f; }
...
other_delimiters1
 = f:generic_func &{ return other_delimiters1[f]; }
   { return f; }
...
other_literals2
 = f:generic_func &{ return other_literals2[f]; }
   { return f; }
...
other_literals3
  ...
  / "\\alef" { return "\\aleph"; } // must be tested after \alefsym
  ...
  / "\\real" { return "\\Re"; } // must be tested after \reals
  / "\\Reals" { return "\\mathbb{R}"; }
  ...
  / "\\sub" { return "\\subset"; } // must be tested after \sube
  ...
  // single-char commands must be tested last
  / "\\C" { return "\\mathbb{C}"; }
  / "\\H" { return "\\mathbb{H}"; }
  / "\\N" { return "\\mathbb{N}"; }
  / "\\Q" { return "\\mathbb{Q}"; }
